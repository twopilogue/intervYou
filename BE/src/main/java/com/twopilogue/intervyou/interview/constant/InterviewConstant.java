...
public class InterviewConstant {
    ...
    public static final String READ_INTERVIEW_SUCCESS_MESSAGE = "면접 기록 조회를 완료했습니다.";
    public static final String READ_INTERVIEW_RECORD_LIST_SUCCESS_MESSAGE = "면접 기록 목록 조회를 완료했습니다.";
